# Token Utility Whitepaper - DRAFT v0.15.0
...
|-----------------------|----------------|--------------|
| Contributor Community | under review   | under review |
| Public Sale           | under review   | under review |
| Community Reserve     | under review   | under review |
| Pre-Seed Investor*    | under review   | under review |
| Seed Investors        | under review   | under review |
| Core Team             | under review   | under review |
| Service Providers     | under review   | under review ||
...
2. A delegated stake is provided for node 1 and node 2. Node 2 has the larger delegated stake which has influenced the probability of node 2 winning the rollup lottery where node 2 is an Aggregator node.
...
### Rewards and Fees
Rewards in Obscuro are an additional incentive to the stake so node operators maintain reliable and accurate nodes thereby contribute to the health of the Obscuro network. During the bootstrapping phase rewards will be limited to the Verifier nodes who will be verifying the accuracy of the signed list of transaction hashes generated by the Aggregator. After the bootstrapping phase the rewards will be extended to the Aggregator nodes for producing the rollup and publishing it to the Layer 1.
...
### Community Reserve
The Community Reserve exists to run and enhance the Obscuro platform and develop and evolve the Obscuro ecosystem over time.  The Obscuro Foundation DAO has oversight of how the Commnity Reserve is put to use. Examples includeengagement with engineering talent, or protocol developers, to further develop the Obscuro platform using tokens as a form of incentive. , settling of legal fees and covering other operational costs, security tests and bug bounty programs, incentivising members of the community to make meaningful contributions to Obscuro via incentive programs, grants, hackathons and competitions.The table below details how the Foundation Fund is potentially used. Do bear in mind the Obscuro Foundation DAO governance process will need to approve these proposed allocations:

| PURPOSE                             | % ALLOCATION | NUMBER TOKENS     | WHEN?          |
|-------------------------------------|--------------|-------------------|----------------|
| Protocol Developers                 | under review | under review      | under review   |
| Legal fees and operational costs    | under review | under review      | under review   |
| Code audits and security tests      | under review | under review      | under review   |
| Bug Bounty                          | under review | under review      | under review   |
| Incentive programs and competitions | under review | under review      | under review   |
| Marketing                           | under review | under review      | under review   |
| Application builders                | under review | under review      | under review   |
| Contingency                         | under review | under review      | under review   |
...
### Market Makers
The Market Maker allocation provides market makers with access to tokens they require to provide liquidity for OBX exchange thereby giving end users the opportunity to acquire OBX use the Obscuro network.
...
Tokens distributed to the Contributor Community unlock over the course of <TBC> days to encourage continued engagement with Obscuro and discourage early dumping.

Tokens distributed to the Public Sale unlock relatively early to allow participation in the Obscuro Mainnet as early as possible without applying downward pressure and making it difficult for others to make use of Obscuro. Specifically, tokens can be used by application users to pay transaction fees, for node operators to stake and for members of the community to participate in delegated staking.
...
Tokens distributed to Investors and the Core Team are initially locked followed by a multi-year unlocks to keep team and investor sentiment high, encourage long term focus in their investment and clearly demonstrate their commitment to the success of Obscuro.
